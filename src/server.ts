...
app.use(bodyParser.json({
  type: function(req: express.Request) { return /^application\/vnd\.api\+json/.test(req.get('content-type')); },
  limit: bodySizeLimit
}));
...
const errorHandler = function(err, req, res: express.Response, next) {
